...
* @returns {any}
*/
module.exports.generateSyncMessage = function(input, sync_state) {
...
* @returns {any}
*/
module.exports.receiveSyncMessage = function(input, sync_state, message) {
    _assertClass(sync_state, JsSyncState);
...
* @returns {any}
*/
module.exports.encodeSyncState = function(sync_state) {
    _assertClass(sync_state, JsSyncState);
...
* @returns {JsSyncState}
*/
module.exports.decodeSyncState = function(sync_state_bytes) {
...
* @returns {any}
*/
module.exports.encodeSyncMessage = function(sync_message) {
...
* @returns {any}
*/
module.exports.decodeSyncMessage = function(sync_message_bytes) {
...
module.exports.JsSyncState = JsSyncState;
/**
*/
class State {
...
module.exports.__wbg_jssyncstate_new = function(arg0) {
...
module.exports.__wbg_isArray_bccef1135dd559c1 = function(arg0) {
...
module.exports.__wbg_instanceof_ArrayBuffer_ee6a79eaea0f4f5b = function(arg0) {
    var ret = getObject(arg0) instanceof ArrayBuffer;
    return ret;
};

module.exports.__wbg_values_0e37ea0767d5caba = function(arg0) {
